...
def GetMessageClass(descriptor_or_name):
    pool = descriptor_pool.Default()
    if isinstance(descriptor_or_name, Descriptor):
        descriptor = descriptor_or_name
    elif isinstance(descriptor_or_name, str):
        descriptor = pool.FindMessageTypeByName(descriptor_or_name)
...
google.protobuf.message_factory.GetMessageClass = GetMessageClass
